...
5: Take a READing'''
    ...
    while tmp not in [1,2,3,4,5]:
        print(s)
        tmp = int(input('Enter one of {1,2,3,4,5}:'))
    ...
    if 1 == tmp:
        ...
        ec.cal_clear()
        print('... done.')
        input('Step 1 of 2: Dry Calibration. Make sure the probe is dry. Hit ENTER when ready...')
        print('Calibrating...')
        ec.cal_dry()
        print('... done.')
        tmp = ''
        ...
        ec.cal_clear()
        print('... done.')
        input('Step 1 of 3: Dry Calibration. Make sure the probe is dry. Hit ENTER when ready...')
        print('Calibrating...')
        ec.cal_dry()
        print('... done.')
